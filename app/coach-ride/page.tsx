...
export default function CoachRidePage() {
  const category = "Coach Ride";
      ...
      <div className="container py-12 md:py-16">
        ...
        <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-r from-primary/10 via-background to-primary/5">
          ...
          <div className="relative p-8 md:p-12">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl md:text-4xl font-headline font-bold">Coach Rides</h1>
            </div>
            <p className="mt-3 md:mt-4 text-muted-foreground md:text-lg">
              Comfortable coach journeys across regions. Filter, compare, and book.
            </p>
        ...
        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          {!loading && filtered.length === 0 && (
            <div className="col-span-full text-center text-muted-foreground">No coach rides found. Try adjusting filters.</div>
          )}
